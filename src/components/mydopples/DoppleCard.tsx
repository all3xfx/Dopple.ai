    ...
    <>
      ...
      >
        ...
        {!loadedBanner && (
          <div
            className={cn(
              "flex h-[140px] w-full items-center justify-center bg-black13",
            )}
          >
            <Image
              width={50}
            ...
            >
              {data.avatarURL && (
                <Image
                  ...
                  fetchpriority="high"
                  className={cn(
                    "lazyload h-[25px] w-[25px] rounded-full",
