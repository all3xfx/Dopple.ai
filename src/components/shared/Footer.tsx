...
export function Footer() {
  ...
  return (
    <footer
      className={cn(
        "relative z-[3] w-full bg-nav md2:pb-0" +
          (!navCollapsed ? " pb-[100px]" : ""),
      )}
    >
      <div className="flex flex-col items-center justify-between px-5 py-[31.26px] text-[#8A939D] xl:px-[60px] lg2:flex-row lg2:py-[34px]">
        <div className="flex flex-col items-center space-y-3 lg2:max-w-[366px] lg2:items-start lg2:space-y-[5.93px]">
          <Link href="/">
            {mode === 0 ? (
              <Image
                width={108}
          ...
          <span className="text-center text-[14px] leading-[150%] lg2:text-left">
            Discover A New Dimension Of Connection.
          </span>
        </div>
        <div className="mb-8 mt-5 flex flex-col items-center space-y-[13px] text-[14px] leading-[17px] lg2:hidden lg2:text-[12px] lg2:leading-[14px]">
          <div className="flex items-center space-x-[15px]">
            <Link
              className="duration-800 transition hover:text-blue2"
              href="/terms"
            >
              Term & Conditions
            </Link>
          ...
          {location.pathname !== "/waitlist-beta" && (
            <div className="flex items-center space-x-[15px]">
              <span className="duration-800 transition hover:text-blue2">
                About
              </span>
            </div>
          )}
        ...
        <div
          className={
            "hidden gap-x-[25px] gap-y-[24px] text-[12px] leading-[14px] text-black6 lg2:flex"
          }
        >
          <Link
            className="duration-800 transition hover:text-blue2"
        ...
        <div className="flex flex-col items-center space-y-[15.47px] md:space-y-3 lg2:items-start">
          <div className="flex space-x-5 md:space-x-[10px]">
            <a
              className="duration-800 flex h-[30px] w-[30px] items-center justify-center rounded-full bg-white text-button transition hover:bg-blue2 dark:bg-blue2 dark:text-white"
              href="https://twitter.com/DoppleAi"
              target="_blank"
              rel="noreferrer"
              aria-label="twitter"
            >
            ...
            <a
              className="duration-800 flex h-[30px] w-[30px] items-center justify-center rounded-full bg-white text-button transition hover:bg-blue2 dark:bg-blue2 dark:text-white"
              href="https://instagram.com/Dopple_ai"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              className="duration-800 flex h-[30px] w-[30px] items-center justify-center rounded-full bg-white text-button transition hover:bg-blue2 dark:bg-blue2 dark:text-white"
              href="https://www.reddit.com/r/DoppleAI/"
              target="_blank"
              rel="noreferrer"
              aria-label="website"
            >
            ...
            <a
              className="duration-800 flex h-[30px] w-[30px] items-center justify-center rounded-full bg-white text-button transition hover:bg-blue2 dark:bg-blue2 dark:text-white"
              href="https://discord.gg/WqHY6VSP"
              target="_blank"
              rel="noreferrer"
              aria-label="website"
            >
          ...
          <span className="text-[14px] leading-[17px] lg2:text-[12px] lg2:leading-[14px]">
            © 2023 Dopple Labs Inc. All Rights Reserved.
          </span>
        </div>
      </div>
      {navCollapsed && (
        <nav
          className={cn(
            "duration-800 block w-full border-t transition md2:hidden",
            mode === 0
